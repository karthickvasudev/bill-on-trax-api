        ...
        return new OncePerRequestFilter() {
            ...
            protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
                ...
                try {
                    ...
                    Optional<AuthenticationDetails> optionalAuthenticationDetails = authenticationDetailsRepository.findByAccessTokenAndRefreshTokenAndUserIdOrderByCreatedTimeDesc(token, refreshToken, extractedToken.getUserId());
